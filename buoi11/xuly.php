<?php
	...
	if(isset($_GET['soto']) and isset($_GET['sothua'])){
		$soto=$_GET['soto'];
		$sothua=$_GET['sothua'];
		...
		$sql="SELECT diachi,shbando,shthua,dientich,tenchusdd,mdsd, ST_AsGeoJSON( ST_Transform(geom,4326))::json as geom from view_duynghia_4326 where ".$where;
